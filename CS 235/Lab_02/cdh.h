...
public:
    ...
    **/
    Cdh(std::string courseName = "No Name Provided", std::string day = "No Day Provided", std::string time = "No Time Provided") : CourseInterface(), courseName(courseName), day(day), time(time) {}
