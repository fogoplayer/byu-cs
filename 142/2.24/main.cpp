...
void numPizzasNeeded(int nufomGuests, int &numLargePizzas, int &numMediumPizzas, int &numSmallPizzas);
...
double calcTotalPizzaArea(int numLargePizzas, int numMediumPizzas, int numSmallPizzas)
{
   ...
   double totalPizzaArea = numLargePizzas * areaOfAPizza(LARGE_PIZZA_DIAMETER) + numMediumPizzas * areaOfAPizza(MEDIUM_PIZZA_DIAMETER) + numSmallPizzas * areaOfAPizza(SMALL_PIZZA_DIAMETER);
