...
void numPizzasNeeded(int numGuests, int& numLargePizzas, int& numMediumPizzas, int& numSmallPizzas){
   const int GUESTS_PER_LARGE_PIZZA = 9;
   const int GUESTS_PER_MEDIUM_PIZZA = 5;
   const int GUESTS_PER_SMALL_PIZZA = 2;
...
double calcTotalPizzaArea(int numLargePizzas, int numMediumPizzas, int numSmallPizzas){
   const double LARGE_PIZZA_DIAMETER = 24.0;
   const double MEDIUM_PIZZA_DIAMETER = 18.0;
   const double SMALL_PIZZA_DIAMETER = 14.0;
...
int calcTotalCost(int tip, int numLargePizzas, int numMediumPizzas, int numSmallPizzas){
   const double LARGE_PIZZA_COST = 15.78;
   const double MEDIUM_PIZZA_COST = 13.25;
   const double SMALL_PIZZA_COST = 8.39;
